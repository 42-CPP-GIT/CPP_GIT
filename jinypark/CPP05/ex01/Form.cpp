...
/*   Updated: 2022/11/22 17:04:15 by jinypark         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Form.hpp"

Form::Form() : name_("Form"), signGrade_(50), executeGrade_(50)
{
}

Form::Form(const std::string name, const int signedGrade, const int executeGrade) : 
name_("Form"), signGrade_(signedGrade), executeGrade_(executeGrade)
{
