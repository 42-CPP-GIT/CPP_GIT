...
/*   Updated: 2022/11/20 21:53:32 by sesim            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name, int hit_point, unsigned int energy_point, unsigned int attack_damage) \
: name_(name), hit_point_(hit_point), energy_point_(energy_point), attack_damage_(attack_damage)
{
	std::cout << "ClapTrap " << this->name_ << " Full Custom Constructor called" << std::endl;
}
